...
TEXT_ELEMENT_SCHEMA = {
    ...
    "properties": {
        ...
        "anchor": {"type": "string", "description": "Optional anchor for linking to this element"},
...
BUTTON_SCHEMA = {
    ...
    "properties": {
        ...
        "on_click": {"type": "string", "description": "Callback function name (as string)"},
...
SLIDER_SCHEMA = {
    ...
    "properties": {
        ...
        "format": {"type": "string", "description": "Display format string"},
        "key": {"type": "string", "description": "Unique key for the widget"},
    },
    "required": ["label"],
}
...
TEXT_INPUT_SCHEMA = {
    ...
    "properties": {
        ...
        "max_chars": {"type": "integer", "description": "Maximum number of characters"},
        "key": {"type": "string", "description": "Unique key for the widget"},
        "type_": {"type": "string", "enum": ["default", "password"], "description": "Input type"},
        "help": {"type": "string", "description": "Tooltip text"},
        "placeholder": {"type": "string", "description": "Placeholder text"},
    },
    "required": ["label"],
...
CHART_SCHEMA = {
    ...
    "properties": {
        ...
        "color": {"type": "string", "description": "Column name for color grouping"},
        "size": {"type": "string", "description": "Column name for size"},
        "width": {"type": "integer", "description": "Chart width"},
        "height": {"type": "integer", "description": "Chart height"},
        "use_container_width": {"type": "boolean", "description": "Use full container width"},
    },
...
TABS_SCHEMA = {
    "type": "object",
    "properties": {
        "labels": {"type": "array", "items": {"type": "string"}, "description": "Tab labels"}
    },
    "required": ["labels"],
}
...
EXPANDER_SCHEMA = {
    "type": "object",
    "properties": {
        "label": {"type": "string", "description": "Expander label"},
        "expanded": {"type": "boolean", "description": "Whether initially expanded"},
    },
    "required": ["label"],
}
...
PAGE_CONFIG_SCHEMA = {
    "type": "object",
    "properties": {
        "page_title": {"type": "string", "description": "Browser tab title"},
        "page_icon": {"type": "string", "description": "Emoji or URL for favicon"},
        "layout": {"type": "string", "enum": ["centered", "wide"], "description": "Page layout"},
        "initial_sidebar_state": {
            "type": "string",
            "enum": ["auto", "expanded", "collapsed"],
            "description": "Initial sidebar state",
        },
        "menu_items": {"type": "object", "description": "Custom menu items"},
    },
}
...
SESSION_STATE_SCHEMA = {
    "type": "object",
    "properties": {
        "variable_name": {"type": "string", "description": "Name of the session state variable"},
        "initial_value": {"description": "Initial value (can be any type)"},
        "description": {
            "type": "string",
...
CACHE_SCHEMA = {
    "type": "object",
    "properties": {
        "function_name": {"type": "string", "description": "Name of the function to cache"},
        "cache_type": {
            "type": "string",
        ...
        "max_entries": {"type": "integer", "description": "Maximum number of cached entries"},
    },
...
DATAFRAME_SCHEMA = {
    ...
    "properties": {
        ...
        "use_container_width": {"type": "boolean", "description": "Use full container width"},
        "hide_index": {"type": "boolean", "description": "Hide the index column"},
        "column_order": {
            "type": "array",
            "items": {"type": "string"},
            "description": "Order of columns to display",
        },
        "column_config": {"type": "object", "description": "Column configuration dictionary"},
    },
    "required": ["data_variable"],
}
...
METRIC_SCHEMA = {
    ...
    "properties": {
        ...
        "delta": {"type": ["string", "number"], "description": "Change from previous value"},
        "delta_color": {
            "type": "string",
