...
def add_button(label: str, key: str | None = None, help_text: str | None = None,
               disabled: bool = False, type_: str = "secondary") -> str:
...
def add_checkbox(label: str, value: bool = False, key: str | None = None,
                 help_text: str | None = None, disabled: bool = False) -> str:
...
def add_toggle(label: str, value: bool = False, key: str | None = None,
               help_text: str | None = None, disabled: bool = False) -> str:
...
def add_radio(label: str, options: List[str], index: int = 0, key: str | None = None,
              help_text: str | None = None, horizontal: bool = False) -> str:
...
def add_selectbox(label: str, options: List[str], index: int = 0, key: str | None = None,
                  help_text: str | None = None, placeholder: str | None = None) -> str:
...
def add_multiselect(label: str, options: List[str], default: List[str] | None = None,
                    key: str | None = None, help_text: str | None = None,
                    placeholder: str | None = None, max_selections: int | None = None) -> str:
...
def add_slider(label: str, min_value: float = 0.0, max_value: float = 100.0,
               value: float | None = None, step: float | None = None,
               format_str: str | None = None, key: str | None = None,
...
def add_select_slider(label: str, options: List[Any], value: Any | None = None,
                      key: str | None = None, help_text: str | None = None) -> str:
...
def add_text_input(label: str, value: str = "", max_chars: int | None = None,
                   key: str | None = None, type_: str = "default",
                   help_text: str | None = None, placeholder: str | None = None) -> str:
...
def add_text_area(label: str, value: str = "", height: int | None = None,
                  max_chars: int | None = None, key: str | None = None,
                  help_text: str | None = None, placeholder: str | None = None) -> str:
...
def add_number_input(label: str, min_value: float | None = None, max_value: float | None = None,
                     value: float | None = None, step: float | None = None,
                     format_str: str | None = None, key: str | None = None,
                     help_text: str | None = None) -> str:
...
def add_date_input(label: str, value: str | None = None, min_value: str | None = None,
                   max_value: str | None = None, key: str | None = None,
                   help_text: str | None = None) -> str:
...
def add_time_input(label: str, value: str | None = None, key: str | None = None,
                   help_text: str | None = None, step: int | None = None) -> str:
...
def add_file_uploader(label: str, type_: List[str] | None = None, accept_multiple_files: bool = False,
                      key: str | None = None, help_text: str | None = None) -> str:
...
def add_color_picker(label: str, value: str = "#000000", key: str | None = None,
                     help_text: str | None = None) -> str:
...
TOOLS = [
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "type": {"type": "string", "enum": ["primary", "secondary"], "description": "Button type"}
            },
            "required": ["label"]
        }
    },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "options": {"type": "array", "items": {"type": "string"}, "description": "List of options"},
                "default": {"type": "array", "items": {"type": "string"}, "description": "Default selections"},
                "key": {"type": "string", "description": "Unique key"},
                "help": {"type": "string", "description": "Tooltip text"},
                "placeholder": {"type": "string", "description": "Placeholder text"},
                "max_selections": {"type": "integer", "description": "Maximum number of selections"}
            },
            "required": ["label", "options"]
        }
    },
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "key": {"type": "string", "description": "Unique key"},
                "type": {"type": "string", "enum": ["default", "password"], "description": "Input type"},
                "help": {"type": "string", "description": "Tooltip text"},
                "placeholder": {"type": "string", "description": "Placeholder text"}
            },
            "required": ["label"]
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "type": {"type": "array", "items": {"type": "string"}, "description": "Accepted file types"},
