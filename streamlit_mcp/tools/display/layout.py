...
def add_columns(num_columns: int = 2, gap: str = "small", vertical_alignment: str = "top") -> str:
...
def add_expander(label: str, expanded: bool = False, icon: str | None = None) -> str:
...
def add_container(height: int | None = None, border: bool = False, key: str | None = None) -> str:
...
def add_popover(
    ...
    if kwargs_str:
        return (
            f'with st.popover("{label}", {kwargs_str}):\n    # Add popover content here\n    pass'
        )
    return f'with st.popover("{label}"):\n    # Add popover content here\n    pass'


def add_dialog(title: str, width: str = "small") -> str:
...
def add_form(
    key: str, clear_on_submit: bool = False, enter_to_submit: bool = True, border: bool = True
) -> str:
...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "label": {"type": "string", "description": "Label for the expander"},
                "expanded": {
                    "type": "boolean",
                    "description": "Whether to start expanded (default: false)",
                    "default": False,
                },
                "icon": {"type": "string", "description": "Optional icon (emoji or icon name)"},
            },
            "required": ["label"],
        },
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "key": {"type": "string", "description": "Unique key for the container"},
            },
        },
    },
    {
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "label": {"type": "string", "description": "Button label for the popover trigger"},
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "key": {"type": "string", "description": "Unique key for the form"},
                "clear_on_submit": {
                    "type": "boolean",
