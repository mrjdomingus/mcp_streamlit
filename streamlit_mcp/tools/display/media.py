...
def add_image(image_source: str, caption: str | None = None,
              width: int | None = None, use_column_width: bool | None = None,
              channels: str = "RGB", output_format: str = "auto") -> str:
...
def add_audio(audio_source: str, format: str = "audio/wav",
              start_time: int = 0, sample_rate: int | None = None,
              end_time: int | None = None, loop: bool = False,
...
def add_video(video_source: str, format: str = "video/mp4",
              start_time: int = 0, end_time: int | None = None,
              loop: bool = False, autoplay: bool = False,
              muted: bool = False, subtitles: str | None = None) -> str:
...
def add_logo(image_source: str, link: str | None = None,
             icon_image: str | None = None, size: str = "medium") -> str:
...
def add_link_button(label: str, url: str, help: str | None = None,
                    type: str = "secondary", disabled: bool = False,
                    use_container_width: bool = False, icon: str | None = None) -> str:
    ...
    },
    {
        ...
        "inputSchema": {
            ...
            "properties": {
                ...
                "subtitles": {
                    "type": "string",
                    "description": "Path to VTT subtitles file"
                }
            },
